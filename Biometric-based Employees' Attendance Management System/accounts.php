    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="home.php">
                ...
                <!-- <div class="sidebar-brand-text mx-3">BES<sup>AMS</sup></div> -->
            </a>
               ...
               <!--  End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                    	...
                    	<div class="container-fluid">
    <div class="container-fluid">
    <h2 class="text-center">Admin Accounts</h2>
    <!-- <p class="datatable design text-center">BATANGAN ELEMENTARY SCHOOL</p> -->
...
<table class="table">
	...
	<tbody>	
		...
		?>
					...
					<td><a class="btn btn-info" href="updateaccnt.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;<a class="btn btn-danger" href="delaccount.php?id=<?php echo $row['id']; ?>">Delete</a></td>
					</tr>	
